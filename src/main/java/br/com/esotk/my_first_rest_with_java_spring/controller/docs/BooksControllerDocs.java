...
public interface BooksControllerDocs {
    ...
    @Operation(summary = "Finds a Books by its ID",
            description = "Finds a Books by its ID",
            tags = {"Books"},
            responses = {
                    @ApiResponse(
                            description = "Success",
    ...
    @Operation(summary = "Creates a new Books",
            description = "Creates a new Books",
            tags = {"Books"},
            responses = {
                    @ApiResponse(
                            description = "Success",
    ...
    BooksDTO criarBooks(@RequestBody BooksDTO books);

    @Operation(summary = "Updates a Books",
            description = "Updates a Books",
            tags = {"Books"},
            responses = {
                    @ApiResponse(
                            description = "Success",
    ...
    BooksDTO atualizarBooks(@RequestBody BooksDTO books);

    @Operation(summary = "Deletes a Books",
            description = "Deletes a Books",
            tags = {"Books"},
            responses = {
                    @ApiResponse(description = "No Content", responseCode = "204", content = @Content),
                    @ApiResponse(description = "Bad Request", responseCode = "400", content = @Content),
    ...
    ResponseEntity<?> excluirBooks(@PathVariable("id") Long id);
}
